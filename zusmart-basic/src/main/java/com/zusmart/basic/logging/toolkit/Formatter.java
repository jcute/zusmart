...
public class Formatter {
	...
	public static FormatterTuple format(String messagePattern, Object arg) {
		return arrayFormat(messagePattern, new Object[] { arg });
	}

	public static FormatterTuple format(final String messagePattern, Object argA, Object argB) {
		return arrayFormat(messagePattern, new Object[] { argA, argB });
	}

	public static FormatterTuple arrayFormat(final String messagePattern, final Object[] argArray) {
		if (argArray == null || argArray.length == 0) {
			return new FormatterTuple(messagePattern, null);
		}
		...
		if (j == -1) {
			return new FormatterTuple(messagePattern, throwable);
		}
		...
		return new FormatterTuple(sbuf.toString(), L <= lastArrIdx ? throwable : null);
	}
