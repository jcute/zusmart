package com.zusmart.inject.util;
...
import com.zusmart.inject.resource.support.ResourceByClassPath;
import com.zusmart.inject.resource.support.ResourceByUrl;
...
public abstract class ResourceUtils {
	...
	public static Resource getResource(String location, ClassLoader classLoader) {
		ClassLoader newClassLoader = null == classLoader ? ClassUtils.getDefaultClassLoader() : classLoader;
		if (null == location) {
